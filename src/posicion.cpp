...
public:
    ...
    : Node("posicion"), x_(0.0), y_(0.0), z_(0.0)
    {
        ...
        control_subscriber_ = this->create_subscription<std_msgs::msg::Float64MultiArray>(
            "output", 10, std::bind(&PosicionNode::control_callback, this, _1));

        init_subscriber_ = this->create_subscription<std_msgs::msg::Float64MultiArray>(
            "iniciador", 10, std::bind(&PosicionNode::control_callback, this, _1));
