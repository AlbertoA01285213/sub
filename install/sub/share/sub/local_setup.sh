...
: ${AMENT_CURRENT_PREFIX:="/home/alberto/ros2_ws/src/sub/install/sub"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sub/environment/pythonpath.sh"
